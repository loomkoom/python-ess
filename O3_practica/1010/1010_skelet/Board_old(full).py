...
def make_board(dimension=10, positions_to_fill=frozenset()):
    ...
    while position is not None:
        board[position] = 'Free'
        position = Position.next(dimension, position)
...
def copy_board(board):
    ...
    #
    # for pos in board:
    #     copy_board[pos] = board[pos]  # dicts, sets
    #
    # return copy_board
...
the_board = make_board(3, {(1, 2), (2, 2), (3, 2)})
print(is_filled_row(the_board, 2))
...
def get_droppable_positions(board, block):
    ...
    for pos in board:
        ...
        for dot in dot_positions:
            ...
            if dot_board_position in board:
